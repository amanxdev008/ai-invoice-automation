...
[![Watch the demo](screenshots/screenshot-workflow-execution.png)](https://youtu.be/g7x9yuP7bNI?si=EWnZjn19mTkokEXh)
...
### Workflow Execution
![Workflow running successfully](screenshots/screenshot-workflow-execution.png)

### AI-Extracted Invoice Data
![Extracted invoice output](screenshots/screenshot-invoice-data.png)
